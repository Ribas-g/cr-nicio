...
from clashroyalebuildabot.gui.deck_selector_widget import DeckSelectorWidget
...
def setup_tabs(main_window):
    ...
    # Adicionar aba de seleção de decks
    from clashroyalebuildabot.deck_manager import DeckManager
    deck_manager = DeckManager()
    main_window.deck_manager = deck_manager
    
    deck_selector_widget = DeckSelectorWidget(deck_manager)
    deck_selector_widget.deck_changed.connect(main_window.on_deck_changed)
    main_window.deck_selector_widget = deck_selector_widget
    tab_widget.addTab(deck_selector_widget, "Decks")
